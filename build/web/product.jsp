...
<head>
    ...
    <title>Cara</title>
    <link href="https:/s/cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <section id="prodetails" class="section-p1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div action="CastServlet" method="post" class="single-pro-details">
                        ...
                        <input name="quantily" type="number" value="1">
